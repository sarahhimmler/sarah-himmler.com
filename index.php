      ...
      <div class="wrapper" id="wrapper">
        <header>
          ...
          <div class="bannerText container">
            <h1>I'm Sarah</h1>
            <h2>I Design &amp; Develop Crafted Web Experiences</h2>
          </div>
          <!--menu start-->
          <div class="menu">
                      ...
                      <div class="navbar-header">
                        ...
                        <div class="navbar-collapse collapse">
                          <ul class="nav navbar-nav">
                            ...
                            <?php /* <li class="menuItem"><a href="#portfolio">Portfolio</a></li> */ ?>
              ...
              <div class="container">
                ...
                <div class="row workDetails">
                  <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                    <div class="workYear">May, 2014<br>
                      Present</div>
                    </div>
                    <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                      ...
                      <div class="exCon">
                        <h4>McKesson</h4>
                        <h5>Mobile Developer/Software Engineer</h5>
                        <p>Working with a great team and developing awesome software.</p>
                      </div>
                    </div>
                  </div>
                  <div class="row workDetails">
                    <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                      <div class="workYear">November, 2009<br>
                        May, 2014</div>
                      </div>
                      <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                        <div class="arrowpart"></div>
                        <div class="exCon">
                          ...
                          <h5>Senior Web Application Developer</h5>
                          <p>Created and worked with business tools, websites and even an iPhone application.</p>
                        </div>
                      </div>
                    </div>
                    <div class="row workDetails">
                      <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                          <div class="arrowpart"></div>
                          <div class="exCon">
                            <h4>Circuit 26 Design</h4>
                            <h5>Lead Developer</h5>
                            <p>Working with a fantastic graphic designer. Circuit 26 Design created beautiful custom websites and web applications.</p>
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  <section class="contactDetails">
    <div class="container">
      ...
      <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
        ...
        <p> <i class="fa fa-envelope-o "></i> <a href="mailto:Sarahlums@gmail.com">Sarahlums@gmail.com</a></p>
        <p> <i class="fa fa-link "></i> <a href="Sarahlums.com">Sarahlums.com</a></p>
      </div>
      <!--contact info end-->

...
<!--<![endif]-->
  <head>
    ...
    <title>Sarah Himmler | Resume</title>
  ...
  <body>
      ...
      <div class="wrapper" id="wrapper">
        <header>
          ...
          <div class="bannerText container">
            <h1>I'm Sarah</h1>
            <h2>I Develop & Design Web Experiences</h2>
          </div>
          <!--menu start-->
          <div class="menu">
            ...
            <div class="container">
              ...
              <div class="row">
                <div class=" col-xs-12 col-sm-12 col-md-7 col-lg-7">
                  ...
                  <!-- <a href="files/Sarah-Himmler_resume.pdf" class="bntDownload">Download Printable Resume</a> -->
                </div>
                <div class=" col-xs-12 col-sm-12 col-md-4 col-lg-4 col-md-offset-1 col-lg-offset-1 proPic">
                  <img src="photos/SarahHimmler.jpg" alt="Sarah's Headshot" class="img-responsive img-circle topmar">
                </div>
              </div>
            </div>
          </section>
              ...
              <div class="container">
                ...
                <div class="row workDetails">
                  <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                    <div class="workYear">October, 2015<br>
                      Present</div>
                    </div>
                  ...
                  <div class="row workDetails">
                    <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                      <div class="workYear">April, 2013<br>
                        September, 2015</div>
                      </div>
                      <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                        <div class="arrowpart"></div>
                    ...
                    <div class="row workDetails">
                      <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                        <div class="workYear">January,2010<br>
                          Present</div>
                        </div>
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                          <div class="arrowpart"></div>
                          <div class="exCon">
                            <h4>Children's World Learning Center</h4>
                            <h5>Lead Teacher</h5>
                            <p>Info</p>
                          </div>
                        </div>
                  ...
                  <section class="education" id="education">
                    <div class="container">
                      <div class="heading">
                        ...
                        <p>My Academic Career</p>
                      </div>
                      <div class="row workDetails">
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                          <div class="workYear">May, 2012</div>
                        </div>
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                          <div class="arrowpart"></div>
                          <div class="exCon">
                            <h4>BA in Human Development</h4>
                            <h5>State University of New York at Oswego</h5>
                            <p>Info</p>
                          </div>
                        </div>
                      </div>
                  ...
                  <section class="exprience" id="exprience">
                    <div class="container">
                      ...
                      <div class="row workDetails">
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                          <div class="workYear">January, 2017<br>
                            Present</div>
                          </div>
                        </div>
                        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 rightArea">
                          <div class="arrowpart"></div>
                          <div class="exCon">
                            <h4>Young Professionals of Pitt County</h4>
      ...
      <div class="container">
        ...
        <ul class="portfolioContainer row">
          <li class="photos col-xs-6 col-sm-4 col-md-3 col-lg-3">
            <div class="lightCon">
              <span class="hoverBox"> <span class="smallIcon">
                <a rel="lightbox-demo" href="images/portfolio/big/1.jpg" title="Project Title1" class="zoom lb lb_warsaw1"><i class="fa fa-search fa-2x"></i></a>
                <a href="#" title="Project Link" target="_blank" class="linKed"><i class="fa fa-link fa-2x"></i></i></a>
              </span> </span>
              <img src="http://placehold.it/450x450&text=image1" alt=""  >
            </div>
          </li>
   ...
   <section class="contact" id="contact">
    ...
    <!-- <div class="row mapArea">
      <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d208156.77770539798!2d-80.6286505!3d35.39410349999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88540562ceaafc4b%3A0xf0a1b8c03ecdaebd!2sConcord%2C+NC!5e0!3m2!1sen!2sus!4v1404100448138&amp;spn=0.01134,0.026157&amp;t=m&amp;z=16&amp;output=embed"></iframe>
    </div> -->
  </section>
  <section class="contactDetails">
    <div class="container">
      ...
      <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
        ...
        <p> <i class="fa fa-map-marker fa-lg"></i> Based in North Carolina</p>
        <p> <i class="fa fa-envelope-o "></i> <a href="mailto:sar.himmler@gmail.com">Email Me</a></p>
        <p> <i class="fa fa-link "></i> <a href="Sarah-Himmler.com">View My Website</a></p>
      </div>
      <!--contact info end-->
